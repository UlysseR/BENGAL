...
import Event1 from "../media/illustration/event.svg"
import ReactFloaterJs from 'react-floaterjs';
import Event2 from "../media/illustration/event2.svg"
    ...
    return (
        <>
            ...
            {/* <NavLink exact to="/evenements">
                <div data-aos="fade-up" className="all-events">TOUS LES EVENEMENTS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img className="lance" src={lance}></img></div></NavLink> */}
        </>
    );
};
