    ...
    <>
      ...
      <div className="container-concept">
        ...
        <div className="concept-content">
         <div data-aos="fade" data-aos-delay="50" className="title-concept">Faciliter l’accessibilité à l’entrepreneuriat :</div> 
          <div data-aos="fade" data-aos-delay="50" className="p-concept"> 
