  ...
  return (
    <>
        ...
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="200" className="title-top">
            ...
            <div className="sous-titre-video">
              Retrouvez tous nos évènements pour commencer à vous créer un
              réseau, parler de vos projets et échanger avec d’autres futurs
              entrepreneurs.
            </div>
          </div>
          <img
      ...
      <div className="event-grid">
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="350" className="event-1">
            <img src={Event1} alt="Evenement1" />
          </div>
        </ReactFloaterJs>
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="200" className="event-2">
            <img src={Event2} alt="Evenement2" />
          </div>
        </ReactFloaterJs>
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="200" className="event-3">
            <img src={Event3} alt="Evenement3" />
          </div>
        </ReactFloaterJs>
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="200" className="event-4">
            <img src={Event4} alt="Evenement4" />
          </div>
        </ReactFloaterJs>
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="200" className="event-5">
            <img src={Event5} alt="Evenement5" />
          </div>
        </ReactFloaterJs>
        <ReactFloaterJs>
          <div data-aos="fade-right" data-aos-delay="200" className="event-6">
